...
/**
 * Two pills at rest, one centred pill once scrolled. Section links stay
 * anchors; the trailing "Sign in" is the only real route, into the product.
 */
    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            href="/login"
            className="rounded-full px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.14em] transition-colors duration-200 hover:bg-white/[0.06]"
