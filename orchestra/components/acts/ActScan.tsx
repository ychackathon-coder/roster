...
import { OrgGraph } from "@/components/ui/OrgGraph";
...
const SOURCE_NOTE: Record<string, string> = {
  ...
  fallback: "model unavailable, this is a sample roster",
};
 ...
 * rules the server uses, so the streamed prefix never has to be rewritten.
 */
